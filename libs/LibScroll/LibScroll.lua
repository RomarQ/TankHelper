...
local DEFAULT_SCROLL_WIDTH 	= 300
local DEFAULT_SCROLL_HEIGHT = 300
...
local function GetCategoriesList(self)
	local categories = {}
...
local function UpdateScrollList(scrollList, dataTable)
	...
	-- Get current categories to be reloaded
	local currentCategories = GetCategoriesList(scrollList)
